    ...
    var g = i(window.flashembed, {
        ...
        getHTML: function(o, l) {
            ...
            if (l) {
				...
				n += '<param name="flashvars" value=\'' + 'config={"clip":{"autoPlay":false,"autoBuffering":true,"url":"a.php"},"plugins":{"controls":{"url":"flowplayer.controls-3.2.4-dev.swf"}},"playerId":"player","playlist":[{"autoPlay":false,"autoBuffering":true,"url":"a.php"}]}' + "' />"
            }
            n += "</object>";
            return n
        },
